...
Com base no que foi coletado do paper, a documentação é um facilitador na hora de entregar o software para uma equipe que não seja a original do projeto; também é uma boa pratica para garantir a qualidade do software. O criação de uma documentação do software é de grande importancia para que possa servir como base para o desenvolvimento de software mais avançados e para projetos futuros. Em contrapartida, muitos alegam o tempo agregado na criação de Documentação. Se a utilização for apenas para uso externo, não pode trazer tantos beneficios para a equipe interna, transformando apenas em um esforço desnecessário. Devido a esse ponto de vista, a solução criada foi a criação de documentação a partir dos comentários feitos no código, assim servindo como base para uma documentação mais enxuta.
